...
public class MemberDAO {
    ...
    private static Member data(CachedRowSet crs){
        try {
            ...
            return new Member(memberId, Fname, Mname, Lname, DateofBirth, PlaceofBirth, Status, CurrentAddress, Occupation, Office, Salary, Sourceofincome, Nearestrelative, RelationShip, Dependent, Stockshare, StockAmount, StockPaid, amountpaid);
